...
{
    public abstract class LegacyArchiveWriter : IDisposable, IModule
    {
        ...
        public LegacyArchiveWriter() { }

        public LegacyArchiveWriter(Stream destination)
        {
        ...
        /// </summary>
        /// <exception cref="ObjectDisposedException">The <see cref="LegacyArchiveWriter"/> has already been closed.</exception>
        ...
        /// <summary>
        /// Releases the resources used by the current instance of the <see cref="LegacyArchiveWriter"/> class.
        /// </summary>
        /// <remarks>This method finishes writing the archive and releases all resources used by the <see cref="LegacyArchiveWriter"/> object.</remarks>
        public void Dispose()
        {
            Dispose(true);
