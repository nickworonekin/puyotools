...
{
    public class SvrPaletteEncoder
    {
        #region Fields
        private SvrTextureEncoder textureEncoder;
        ...
        internal SvrPaletteEncoder(SvrTextureEncoder textureEncoder, byte[] palette, int count)
        {
