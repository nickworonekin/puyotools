...
namespace PuyoTools.Core.Textures.Pvr
{
    public class PvrPalette
    {
        ...
        /// </summary>
        public virtual PvrPixelFormat PixelFormat { get; private set; }
        #endregion
        ...
        public PvrPalette(Stream source)
        {
            Initialize(source);
        }

        protected PvrPalette()
        {
        }
        ...
        /// <summary>
        /// Determines if this is a PVR palette.
        /// </summary>
        /// <param name="source">The stream to read from. The stream position is not changed.</param>
        /// <returns>True if this is a PVR palette, false otherwise.</returns>
