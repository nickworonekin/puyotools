/*
 * This implementation is derived from the .NET source for System.Progress<T>.
 * https://source.dot.net/#System.Private.CoreLib/src/libraries/System.Private.CoreLib/src/System/Progress.cs
 */
...
namespace PuyoTools.App
{
    ...
    public class SynchronousProgress<T> : IProgress<T>
    {
        ...
        public SynchronousProgress()
        {
            ...
            _synchronizationContext = SynchronizationContext.Current ?? SynchronousProgressStatics.DefaultContext;
        ...
        /// the <see cref="SynchronousProgress{T}"/> at construction, it's possible that this handler instance
