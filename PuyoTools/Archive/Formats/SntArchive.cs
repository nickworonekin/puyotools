...
namespace PuyoTools.Archive
{
    public class SntArchive : ArchiveBase
    {
        ...
        {
            return new Write(destination, (settings as SntWriterSettings) ?? new SntWriterSettings());
        }
        ...
        {
            SntWriterSettings settings;

            public Write(Stream destination) : this(destination, new SntWriterSettings()) { }

            public Write(Stream destination, SntWriterSettings settings)
            {
            ...
            public override void Flush()
            {
                ...
                if (settings.Type == SntWriterSettings.SntType.Ps2)
                {
